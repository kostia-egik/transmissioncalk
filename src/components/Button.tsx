...
const Button: React.FC<ButtonProps> = ({ id, onClick, children, variant = 'primary', className = '', disabled = false, title, type = 'button' }) => {
  let baseStyle = "inline-flex items-center justify-center px-6 py-2 rounded-md font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-75 transition-colors duration-200";
