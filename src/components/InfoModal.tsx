                                 ...
                                 <ul className="list-disc list-inside pl-4 space-y-4">
                                    ...
                                    <li>
                                        ...
                                        <p className="pl-4 mt-1">
                                            Если на "Рабочем столе" были сделаны изменения, которые конфликтуют с текущей компоновкой (например, смена типа передачи с параллельной на угловую), при возврате на схему появится диалог:
                                        </p>
                                         <ul className="list-[circle] list-inside ml-4 mt-1 space-y-1">
                                            <li><strong>"Применить и перестроить схему"</strong>: Аналогично кнопке "Перестроить схему (Сброс)", применяет все изменения с "Рабочего стола", но <strong>полностью сбрасывает</strong> ручную компоновку.</li>
                                            <li><strong>"Отменить изменения и вернуться к схеме"</strong>: <strong>Откатывает все изменения</strong>, сделанные на "Рабочем столе", возвращая вас к сохраненной компоновке схемы. Данные на "Рабочем столе" и на схеме снова будут синхронизированы.</li>
                                            <li>Если изменения не конфликтуют со структурой, параметры на схеме обновятся автоматически при возврате.</li>
